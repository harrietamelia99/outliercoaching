...
/**
 * Default copy and URLs for the landing template (Joe’s voice — placeholders).
 *
 * @return array<string, string>
 */
function oc_landing_default_meta() {
	return array(
		'oc_hero_headline'       => 'For those who want something different.',
		'oc_hero_subhead'       => 'Coaching for people who don\'t want coaching.',
		'oc_hero_cta_text'       => "Let's have a conversation",
		'oc_hero_cta_url'        => '#contact',

		'oc_problem_s1'          => 'A new start. A different life.',
		'oc_problem_s2'          => 'A change you have wanted for a while that has not happened yet.',
		'oc_problem_s3'          => 'We help make it happen.',
		'oc_problem_orange_word' => 'happen.',

		'oc_path_intro'          => 'We will find you where you are and walk with you where you\'re going.',

		'oc_step1_label'         => 'Conversation',
		'oc_step1_desc'          => 'You get in touch. You speak to a real person. After 20 minutes, you decide if you want to go further.',
		'oc_step2_label'         => 'Experience',
		'oc_step2_desc'          => 'Online or in person. North Devon, beach, Exmoor, woods, fires, water, wilderness.',
		'oc_step3_label'         => 'Retreats',
		'oc_step3_desc'          => 'Bring yourself or your team. A day, a few nights, or go to Ghana.',
		'oc_step4_label'         => 'Collective',
		'oc_step4_desc'          => '',

		'oc_offer1_title'        => 'Online Sessions',
		'oc_offer1_location'     => 'Anywhere',
		'oc_offer1_text'         => "The easiest way in. Accessible anywhere.\n\nPerson-centred, solution-focused. Tools designed for everyday life, no jargon.",
		...
		'oc_offer2_title'        => 'In-Person Sessions',
		'oc_offer2_location'     => 'North Devon',
		'oc_offer2_text'         => 'At the beach. On Exmoor. In the woods, by fires, near water. Bring yourself or your team.',
		'oc_offer3_title'        => 'Outlier Retreats',
		'oc_offer3_location'     => 'UK · Ghana · Portugal',
		'oc_offer3_text'         => 'Get out of the office. Turn your phone off. These trips are designed to do two things: be fun and change your life.',
		...
		'oc_philosophy_text'     => "You are already brilliant.\n\nYou just need to stop doing the crappy things.\n\nSimple psychology. Tools you can use today.\n\nPerson-centred, solution-focused.\n\nNo endless process.",

		'oc_testimonials_label'  => 'What people say',
		'oc_testimonial_1'       => 'Joe is different. Good different. Very good different. I\'ve worked with a variety of coaches over the years but can honestly say that I have developed the most - both personally and professionally - with Joe. His approach is unique. I am encouraged to think deeply and do better and be better.',
		'oc_testimonial_2'       => 'Want a different type of coach? He gets to the core of the issue whilst getting you to reflect, question, laugh, cry (in a good way), and solve the problem. I leave feeling challenged, like I\'ve had therapy, leadership development and great fun. Book it - it\'s rare to find someone of this quality.',
		'oc_testimonial_3'       => 'He has been instrumental in transforming the way I think, behave and manage my leadership role. He is so in tune with what you think and feel and can very quickly delve deeper into the why and what but ultimately the how to make things better.',
		'oc_testimonial_4'       => 'Joe\'s sessions feel more like soul-searching, which feeds into both the logical and emotional brain. Inherently helpful and I am already grateful for his sincere interest and commitment to helping me grow as a leader, and a person.',

		'oc_upcoming_talks_label' => 'Upcoming talks',
		'oc_utalk_1_title'       => 'Deliberate Leadership intro',
		'oc_utalk_1_meta'        => 'North Devon · 14 May 2026',
		'oc_utalk_1_desc'        => 'Open session. Spaces limited.',
		'oc_utalk_1_url'         => '',
		'oc_utalk_2_title'       => 'Life can be better',
		'oc_utalk_2_meta'        => 'Southern Portugal · September 2026',
		'oc_utalk_2_desc'        => 'Workshop week. More detail when dates firm up.',
		'oc_utalk_2_url'         => '',
		'oc_utalk_3_title'       => 'Coaching week, Ghana',
		'oc_utalk_3_meta'        => 'Mankoadze · ask for dates',
		'oc_utalk_3_desc'        => 'Teaching, coaching, and leadership in country.',
		'oc_utalk_3_url'         => '',
		'oc_utalk_4_title'       => '',
		'oc_utalk_4_meta'        => '',
		'oc_utalk_4_desc'        => '',
		...
		'oc_contact_body'        => 'You speak to a real person. No data collected. No notes made. Just' . "\xc2\xa0" . 'a' . "\xc2\xa0" . 'conversation. Book a free 20-minute slot and go from there.',
		'oc_confidentiality_text' => 'Outlier Coaching is 100% confidential. You are not a case study, No notes are kept, no data is studied, no trends are looked at. You talk, they listen. Good questions, good answers.',
